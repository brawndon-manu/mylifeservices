  ...
  return (
    <section className="mx-auto max-w-3xl px-6 py-10">
      ...
      <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted">
        Somebody told you they could not clock in or out. Upload that day&apos;s clock export and service
        notes, tick their shift, take down what they said, and send them the form to confirm and sign.
      </p>
