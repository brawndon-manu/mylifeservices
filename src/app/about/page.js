...
function Section({ bg, children }) {
  ...
  return (
    <section className={`${bgClass} border-t border-slate-200`}>
...
function PhotoSlot({ ratio, label, hint }) {
  return (
    <div
      className={`${ratio} flex w-full items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-slate-100 px-6 text-center`}
    >
      <div>
